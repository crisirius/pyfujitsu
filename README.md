...
This is a platform to support Fujitsu General Airconditioners under Climate component of Home Assistant. The Python supporting library for accessing the FGLair API is located at: https://github.com/Mmodarre/pyfujitsu and extra Modification for use Home Assistent after 2021.6

### Sample UI:

![UI_SCREENSHOT](https://github.com/crisirius/pyfujitsu/blob/master/Capture.PNG)
![UI_SCREENSHOT](https://github.com/crisirius/pyfujitsu/blob/master/Capture2.PNG)
